#!/bin/bash
# Autoscript Lite (Simple Versio)
# Recomendasi OS Ubuntu 20 or Debian 10
# Author Julak Bantur (Julak Vpn)
# Last Update ©2025
#########################
red='\e[1;31m'
green='\e[0;32m'
...
# --- Membuat Directory Untuk Folder Xray dan lainnya --- #
rm -rf /etc/per
...
# --- Tambahkan domain untuk host semua protocol vpn --- #
yellow "Tambahkan domain yang sudah di pointing di cloudflare "
echo " "
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install Backu Server               $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
clear
wget -q https://raw.githubusercontent.com/galat41/hss/main/bckp/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
#Instal Xray
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
clear
#Install Ssh Udp Custom
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green          Install SSH UDP              $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
clear
wget -q https://raw.githubusercontent.com/galat41/hss/main/udp-custom.sh &&  chmod +x udp-custom.sh && ./udp-custom.sh
clear
#install Semua menu Script
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
# --- Sisipkan Informasi port dan service Autoscript --- #
...
# --- Hapus Berkas install yang tersimpan di vps --- #
rm /root/setup.sh >/dev/null 2>&1
...
# --- Reboot dulu ya sayang --- #
echo -ne "[ ${yell}WARNING${NC} ] Silahkan reboot dulu, Reboot Sekarang ? (y/n)? "
read answer
