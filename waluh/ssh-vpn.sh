...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/galat41/bkn/main/waluh/nginx.conf"
...
wget https://raw.githubusercontent.com/galat41/bkn/main/purut/dropbear.sh && chmod +x dropbear.sh && ./dropbear.sh
